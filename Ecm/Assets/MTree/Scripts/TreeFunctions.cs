...
namespace Mtree
{
    ...
    public class TreeFunction // All Functions are implemented in one class since Unity doens't Serialize child classes
    {
        ...
        // Leaf Parameters
        public int LleafType = 0;
        public string[] LleafTypesNales = { "cross", "diamond cross", "diamond", "long", "custom" };
        public Mesh[] LleafMesh = { Resources.LoadAll<Mesh>("Mtree/branches")[0] };
