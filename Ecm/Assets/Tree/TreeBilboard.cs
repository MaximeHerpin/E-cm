...
namespace Mtree
{
    class Billboard
    {
        ...
        public void Render(string path)
        {
            ...
            rects = atlas.PackTextures(sides, 1, 1024);
        ...
        public Mesh CreateMesh()
        {
            ...
            for (int i=0; i<4; i++)
            {
                ...
                normals[4 * i] = (x + .1f*normal).normalized;
                normals[4 * i + 1] = (x + .1f*normal).normalized;
                normals[4 * i + 2] = (-x + .1f*normal).normalized;
                normals[4 * i + 3] = (-x + .1f*normal).normalized;
        ...
        {
            Bounds bb = target.GetComponent<MeshRenderer>().bounds;
            Shader shader = Shader.Find("Mtree/billboard");
